...
export class UserController {
    ...
    login = catchAsync(async (req, res) => {
        ...
        return res.status(StatusCodes.OK).send(new ApiResponse(StatusCodes.OK, configs.NODE_ENV == "development" ? { otp: sentOTP.verificationOTP } : null, "OTP sent successful"))
    });
